...
switch($numberofcolumns)
{
	...
	case 6: $classes = 'col-xs-4 col-sm-3 col-md-2'; break;
	case 4: $classes = 'col-xs-6 col-sm-3 col-md-3'; break;
	case 3: $classes = 'col-xs-4 col-sm-4 col-md-4'; break;
	case 2: $classes = 'col-xs-6 col-sm-6 col-md-6'; break;
	case 1: $classes = 'col-xs-12 col-sm-12 col-md-12'; break;
